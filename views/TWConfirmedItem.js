...
:null}
       ...
       <Text style={{alignSelf: 'flex-start'}}>Room Price</Text>
               <TextInput
                        ...
                        autoFocus={true}
                        value={newdar.rate_mode =='Daily'?newdar.roomprice+ '/Night': newdar.rate_mode == 'Hour'?newdar.roomprice_hour+ ' /'+newdar.hour_duration+'Hour': newdar.rate_mode =='Promo' && newdar.duration_mode== 'Daily'?newdar.roomprice+' /'+newdar.promo_duration+'Nights': newdar.promo_price_hour+' /'+newdar.promo_duration+'Hours' }
                        editable = {false}
                    />    
