...
export function HourPromoCheckinSheet({ navigation, route }) {
...
<Body>
<Text style={{ fontSize: 13,fontWeight: 'bold'}}>₱{checkinInfo.hour_key  == 'Daily' ? checkinInfo.price +' /'+ checkinInfo.hour_duration+ 'Night': checkinInfo.hour_price+' /'+ checkinInfo.hour_duration+ 'Hours'}</Text>
